...
<body>
  <div class="app">
    ...
    <main class="main">
      <div class="topbar"><div class="topbar-title">Régimes</div><div class="topbar-actions"><a class="btn btn-ghost btn-sm" href="<?= site_url('admin/regimes/create') ?>">Créer un régime</a></div></div>
      <div class="content">
