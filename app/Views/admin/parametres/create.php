...
<head>
  ...
  <title>Admin — Créer paramètre</title>
...
<body>
  <div class="app">
    <aside class="sidebar">
      ...
      <a href="<?= site_url('admin/parametres') ?>" class="nav-item active"><svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="3"/><path d="M19.07 4.93a10 10 0 0 1 0 14.14M4.93 4.93a10 10 0 0 0 0 14.14"/></svg>Paramètres</a>
    ...
    <main class="main">
      <div class="topbar">
        <div class="topbar-title">Créer paramètre</div>
        <div class="topbar-actions"><a class="btn btn-secondary btn-sm" href="<?= site_url('admin/parametres') ?>">Retour</a></div>
      </div>
      <div class="content">
        <div class="form-card">
          <form method="post" action="<?= site_url('admin/parametres/create') ?>">
            <?= csrf_field() ?>
            <div class="form-section-title">Nouveau paramètre</div>
            <div class="form-grid cols-1">
              <div><label class="field-label" for="cle">Clé<span class="required">*</span></label><input id="cle" name="cle" required></div>
              <div><label class="field-label" for="valeur">Valeur<span class="required">*</span></label><input id="valeur" name="valeur" required></div>
              <div><label class="field-label" for="description">Description</label><input id="description" name="description"></div>
            </div>
            <div style="display:flex; justify-content:flex-end; gap:10px; margin-top:12px;">
              <a class="btn btn-secondary" href="<?= site_url('admin/parametres') ?>">Annuler</a>
