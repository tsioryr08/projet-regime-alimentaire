  ...
  <div class="app">
    ...
    <main class="main">
      <div class="topbar">
        ...
        <div class="topbar-actions"><a class="btn btn-ghost btn-sm" href="<?= site_url('admin/parametres/create') ?>">Créer un nouveau paramètre</a></div>
      </div>
      <div class="content">
        <div class="table-card">
          <div class="card-header"><div><div class="card-title">Paramètres système</div><div class="subtitle">Modifiez les valeurs et descriptions directement.</div></div></div>
              ...
              <tbody>
                <?php foreach (($parametres ?? []) as $parametre): ?>
                  <tr>
                    ...
                    <td><a class="btn btn-danger btn-sm" href="<?= site_url('admin/parametres/delete/' . $parametre['id']) ?>" onclick="return confirm('Supprimer ce paramètre ?')">Supprimer</a></td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
            </table>
            <div style="display:flex; justify-content:flex-end; margin-top:12px;"><button type="submit" class="btn btn-primary">Enregistrer</button></div>
          </form>
        </div>
      </div>
    </main>
