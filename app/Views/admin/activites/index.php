...
<body>
  <div class="app">
    ...
    <main class="main">
      <div class="topbar"><div class="topbar-title">Activités</div><div class="topbar-actions"><a class="btn btn-ghost btn-sm" href="<?= site_url('admin/activites/create') ?>">Créer une activité</a></div></div>
      <div class="content">
        <div class="table-card">
          <div class="card-header" style="align-items:flex-start;">
            <div style="display:flex; flex-direction:column; gap:4px;">
              <div class="card-title">Liste des activités</div>
              <div class="subtitle" style="margin:0;">Suivi des activités et de leurs paramètres.</div>
            </div>
            <a class="btn btn-primary btn-sm" href="<?= site_url('admin/activites/create') ?>">Nouvelle activité</a>
          </div>
          <table>
            ...
            <tbody>
              <?php foreach (($activites ?? []) as $activite): ?>
                <tr>
                  ...
                  <td><a class="btn btn-ghost btn-sm" href="<?= site_url('admin/activites/edit/' . $activite['id']) ?>">Modifier</a></td>
                </tr>
              <?php endforeach; ?>
            </tbody>
          </table>
